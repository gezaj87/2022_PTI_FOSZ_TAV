        ...
        <div class="auto-col d-flex justify-content-center">
            <div class="content">
                <form class="regisztracio" method="POST" action="register">
                    ...
                    <input type="text" name="felhasznalonev" id="regisztracioNev_id" name="name" required><br>
                    ...
                    <input type="date" name="regisztracioSzulDatum" id="regisztracioSzulDatum_id" name="date" required><br>                         
                    <label class="regisztracioCimke" for="regisztracioTel_id">Telefonszám</label>
                    <input type="tel" id="regisztracioTel_id" pattern="[0]{1}[0-9]{10}" placeholder="201234567" name="phone" required><br>
